...
func NewDiscordBot(session discord.Session, cfg *config.Config, gatewayHandler discord.GatewayEventHandler, logger observability.Logger, eventBus eventbus.EventBus, router *message.Router) (*DiscordBot, error) {
