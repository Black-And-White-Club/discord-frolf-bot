...
func (m *MockHandlers) HandleProcessRoundScoresFailedTyped(ctx context.Context, payload *scoreevents.ProcessRoundScoresFailedPayloadV1) ([]handlerwrapper.Result, error) {
	m.ctrl.T.Helper()
