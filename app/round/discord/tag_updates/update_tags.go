...
func (tum *tagUpdateManager) UpdateDiscordEmbedsWithTagChanges(ctx context.Context, payload roundevents.ScheduledRoundsSyncedPayloadV1, tagUpdates map[sharedtypes.DiscordID]*sharedtypes.TagNumber) (TagUpdateOperationResult, error) {
