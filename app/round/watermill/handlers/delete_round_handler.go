...
// 	}
// 	backendMsg, err := h.Helpers.CreateResultMessage(msg, backendPayload, roundevents.RoundDeleteRequest)
// 	if err != nil {
// 		return nil, err
// 	}
...
// 	}
// 	discordMsg, err := h.Helpers.CreateResultMessage(msg, discordPayload, discordroundevents.RoundDeletedTopic)
// 	if err != nil {
// 		return nil, err
// 	}
