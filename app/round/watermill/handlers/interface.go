...
type Handlers interface {
	// Creation flow
	HandleRoundCreateRequested(ctx context.Context, payload *sharedroundevents.CreateRoundModalPayloadV1) ([]handlerwrapper.Result, error)
	...
	// Update flow
	HandleRoundUpdateRequested(ctx context.Context, payload *sharedroundevents.RoundUpdateModalSubmittedPayloadV1) ([]handlerwrapper.Result, error)
	...
	// Participation
	HandleRoundParticipantJoinRequest(ctx context.Context, payload *sharedroundevents.RoundParticipantJoinRequestDiscordPayloadV1) ([]handlerwrapper.Result, error)
	...
	HandleScoreOverrideSuccess(ctx context.Context, payload *scoreevents.ScoreUpdatedPayloadV1) ([]handlerwrapper.Result, error)
	...
	// Deletion flow
	HandleRoundDeleteRequested(ctx context.Context, payload *sharedroundevents.RoundDeleteRequestDiscordPayloadV1) ([]handlerwrapper.Result, error)
